...
//        UInt8 xoneInit4[] = { 0x09, 0x00, 0x03, 0x09, 0x00, 0x0f, 0x00, 0x00, 0x1d, 0x1d, 0xff, 0x00, 0x00 };
        UInt8 xoneInit1[] = { 0x04, 0x20, 0x01, 0x00 };
        UInt8 xoneInit2[] = { 0x01, 0x20, 0x01, 0x09, 0x00, 0x04, 0x20, 0x3a, 0x00, 0x00, 0x00, 0x98, 0x00 };
        UInt8 xoneInit3[] = { 0x01, 0x20, 0x02, 0x09, 0x00, 0x04, 0x20, 0xd2, 0x00, 0x00, 0x00, 0x00, 0x00 };
        UInt8 xoneInit4[] = { 0x05, 0x20, 0x02, 0x09, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x55, 0x53 };
        UInt8 xoneInit5[] = { 0x05, 0x20, 0x03, 0x01, 0x00 };
        UInt8 xoneInit6[] = { 0x0a, 0x20, 0x04, 0x03, 0x00, 0x01, 0x14 };
        UInt8 xoneInit7[] = { 0x09, 0x00, 0x05, 0x09, 0x00, 0x0f, 0x00, 0x00, 0x1d, 0x1d, 0xff, 0x00, 0x00 };
        ...
        QueueWrite(&xoneInit5, sizeof(xoneInit5));
        QueueWrite(&xoneInit6, sizeof(xoneInit6));
        QueueWrite(&xoneInit7, sizeof(xoneInit7));
    } else {
        // Disable LED
